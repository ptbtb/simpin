    ...
    <div class="card-body"><div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel" style="width:50%;">
                    <form action="/setting/simpanan/store" method="post" id="form">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>Kode Simpanan</label>
                            <input type="text" class="form-control" name="kode_jenis_simpan" size="54" value="" />
                        </div>
                        <div class="form-group">
                            <label>Jenis Simpanan</label>
                            <input type="text" class="form-control" name="nama_simpanan" size="54" value=""/>
                        </div>
                        <script>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" onkeypress="return isNumberKey(event)" name="besar_simpanan" size="54" value=""/>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Tagih</label>
                            <input type="text" class="form-control" name="tgl_tagih" >
                        </div>
                        <div class="form-group">
                            <label>Hari Jatuh Tempo </label>
                            <input type="text" class="form-control" name="hari_jatuh_tempo" >
                        </div>
                        <div class="form-group">
