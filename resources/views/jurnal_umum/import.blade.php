...
<div class="row">
	...
	<div class="col-6">
		<ol class="breadcrumb float-sm-right">
			...
			<li class="breadcrumb-item active">Import Jurnal Umum</li>
		</ol>
	</div>
</div>
@endsection
...
<div class="row">
    <div class="col-md-6 offset-md-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('import-jurnal-umum') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <a href="{{ asset('template-excel/templateimportjurnalumum.xlsx') }}">Download Template Excel Here</a>
                    </div>
                    <div class="form-group ">
