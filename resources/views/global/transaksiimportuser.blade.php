...
<div class="row">
	...
	<div class="col-6">
		<ol class="breadcrumb float-sm-right">
			...
			<li class="breadcrumb-item active">Import Transaksi User</li>
		</ol>
	</div>
</div>
@endsection
...
<div class="row">
    <div class="col-md-6 offset-md-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('global-transaksiuser-import-excel') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <a href="{{ asset('template-excel/template-transaksiuser.xlsx') }}">Download Template Excel Here</a>
                    </div>
                    <div class="form-group ">
