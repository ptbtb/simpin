...
<div class="row">
    <div class="col-md-6 offset-md-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('transferred-shu.storeImport') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <a href="{{ asset('template-excel/shu-transfer-template.xlsx') }}">Download Template Excel Here</a>
                    </div>
                    <div class="form-group ">
